...
import xyz.hollywoodhub.hollywoodhub.rest.gomovies.GetFiltersApi;
...
public class FilterContentListFragment extends ContentListFragment {
    ...
    private SparseArray<FilterModel> filterModels;

    public static FilterContentListFragment newInstance(String categoryId) {
        FilterContentListFragment fragment = new FilterContentListFragment();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        filterModels = eventBus.getStickyEvent(SparseArray.class);
    ...
    void fetchContents(final int pageNo) {
        showProgress();
        new GetFiltersApi(categoryId, pageNo + "", filterModels, new IRestCallBacks<String>() {
            @Override
